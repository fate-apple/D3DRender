...
static bool checkTearingSupport(DxGIFactory factory)
{
...
static Dx12Swapchain createSwapChain(HWND windowHandle,
	DxGIFactory factory, const DxCommandQueue& commandQueue,
	uint32 width, uint32 height, uint32 bufferCount, bool tearingSupported, color_depth colorDepth, bool exclusiveFullscreen)
{
	Dx12Swapchain dxgiSwapChain;
...
static bool checkForHDRSupport(DxGIFactory factory, RECT windowRect, color_depth colorDepth)
{
...
static void setSwapChainColorSpace(Dx12Swapchain swapchain, color_depth colorDepth, bool hdrSupport)
{
