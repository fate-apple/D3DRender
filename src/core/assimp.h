...
const aiScene* loadAssimpSceneFile(const fs::path& filepath, Assimp::Importer& importer, bool allow16BitIndices = true);
ref<struct PbrMaterial> loadAssimpMaterial(const aiScene* scene, const fs::path& sceneFilepath, const aiMaterial* material);
