...
void renderImGui(struct DxCommandList* cl);
...
namespace ImGui
{
	...
	void Image(struct DxCpuDescriptorHandle& handle, ImVec2 size);
	void Image(struct DxCpuDescriptorHandle& handle, uint32 width, uint32 height);
	void Image(const ref<DxTexture>& texture, ImVec2 size);
	void Image(const ref<DxTexture>& texture, uint32 width = 0, uint32 height = 0);

	bool ImageButton(struct DxCpuDescriptorHandle& handle, ImVec2 size, ImVec2 uvTopLeft = ImVec2(0, 0), ImVec2 uvBottomRight = ImVec2(1, 1));
	bool ImageButton(struct DxCpuDescriptorHandle& handle, uint32 width, uint32 height, ImVec2 uvTopLeft = ImVec2(0, 0), ImVec2 uvBottomRight = ImVec2(1, 1));
	bool ImageButton(const ref<DxTexture>& texture, ImVec2 size, ImVec2 uvTopLeft = ImVec2(0, 0), ImVec2 uvBottomRight = ImVec2(1, 1));
	bool ImageButton(const ref<DxTexture>& texture, uint32 width, uint32 height, ImVec2 uvTopLeft = ImVec2(0, 0), ImVec2 uvBottomRight = ImVec2(1, 1));
